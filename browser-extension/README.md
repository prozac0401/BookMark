...
**0.1.5부터 확장은 선택 사항입니다.** Edge·Chrome에서 앱의 Ctrl+Alt+B 또는 트레이의 ‘웹페이지 URL로 추가…’로 확장 없이 저장할 수 있습니다. [확장 없는 사용법](../docs/browser-without-extension.ko.md).
...
- 0.1.5부터는 브라우저에서 Ctrl+Alt+B로 확장 없이 저장할 수 있습니다. 주소를 확인하지 못하면 URL 직접 입력을 안내합니다. 확장으로 저장할 때 문제가 생기면 **이 페이지 저장** 버튼을 누르고 표시되는 오류를 확인하세요.

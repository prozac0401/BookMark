...
public sealed record WorkerRequest(int ProtocolVersion, Guid RequestId, Operation Operation, DateTimeOffset DeadlineUtc, TargetSnapshot? Snapshot = null, CapturedTarget? Target = null);
public sealed record WorkerResponse(int ProtocolVersion, Guid RequestId, ResultCode Code, CapturedTarget? Target = null, bool ExternalActionStarted = false, long TargetHwnd = 0);

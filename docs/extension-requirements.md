...
> 2026-09-21 추가 변경: 데스크톱 Excel·Word·PowerPoint의 HTTP/HTTPS 문서 주소와 작업 위치를 지원합니다. 아래의 기존 로컬 문서 한정 조건은 웹 문서에 대해서 [Office URL 지원 명세·자체 검증 안내](office-url-support.ko.md)로 확장합니다. 사내 AD 실기검증은 사용자가 진행합니다.

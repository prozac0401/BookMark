...
> 2026-09-22 0.2.0: 설정에서 목록·포스트잇 표시를 선택하고, 스티커의 위치·크기·접기·고정 상태를 저장합니다. 목록과 스티커가 같은 책갈피를 사용하며 삭제·복원도 함께 반영됩니다. [릴리스 기록](release-notes-v0.2.0.md)과 [스티커 검증 증거](evidence/stickers-2026-09-22/README.md)에서 확인 범위를 구분합니다. 자동검사와 폼 확인은 실제 입력 장치를 통한 이동·크기 조절, 여러 모니터·혼합 화면 배율 실기를 대신하지 않습니다. 기존 Office·브라우저·사내 인증과 실제 설치·재로그인의 미실행 범위는 그대로 유지합니다.

> 2026-09-22 0.1.5: 사용자가 기존 웹 Office 열기를 확인한 뒤 보고한 루트 최초 접속과 확인 지연을 개선했습니다. 확장 없는 브라우저 갈무리·수동 URL 입력 및 사용자별 MSI를 추가했습니다. [변경·검증 범위](release-notes-v0.1.5-preview.1.md). 기존 버전에서의 사용자 확인이 새 인증 복구나 MSI 재부팅 검증을 대신하지는 않습니다.
...
아래 표의 검증일은 2026-09-19입니다. 0.2.0의 최신 변경과 확인 결과는 [릴리스 기록](release-notes-v0.2.0.md)과 [스티커 검증 증거](evidence/stickers-2026-09-22/README.md)를 참고하세요. 소스 구현과 실제 환경 지원을 구분합니다.
